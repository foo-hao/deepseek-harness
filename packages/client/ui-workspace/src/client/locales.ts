...
export const zh = {
  ...
  'suggest.failed': '无法生成建议',
  'suggest.retry': '重试',
  'suggest.aria': '使用建议“{title}”',
  'delete.workspace': '删除工作区',
  'delete.desc': '将把“{name}”从工作区列表中移除。文件夹与会话记录会保留，其会话将显示在“未分组”下。',
  'delete.pending': '正在删除工作区…',
  'menu.fork': '分叉会话',
  'menu.archiveSession': '归档会话',
  'menu.moveToProject': '移到其他工程',
  'move.title': '移到其他工程',
  'move.empty': '没有其他工作区',
...
export const en = {
  ...
  'suggest.label': 'Suggested titles',
  'suggest.loading': 'Generating suggestions…',
  'suggest.failed': 'Could not generate suggestions',
  'suggest.retry': 'Retry',
  'suggest.aria': 'Use suggested title {title}',
  'delete.workspace': 'Delete workspace',
  'delete.desc': 'This removes “{name}” from the workspace list. The folder and session logs will be kept. Its sessions will appear under Ungrouped.',
  'delete.pending': 'Deleting workspace…',
  'menu.fork': 'Fork session',
  'menu.archiveSession': 'Archive session',
  'menu.moveToProject': 'Move to another project',
  'move.title': 'Move to another project',
  'move.empty': 'No other workspaces',
