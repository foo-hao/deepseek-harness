 ...
 */
export function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onMoveToProject, onArchive, drag, flat = false, t }: {
  node: SessionNode
  currentId: string | undefined
  now: number
  ...
  /** Relocate this session into another project (fork into a target Workspace). */
  onMoveToProject: (id: SessionNode['id']) => void
  ...
  const sessionMenuItems = [
    ...
    { id: 'move', label: t('menu.moveToProject'), icon: <IconFolderOpenOutline16 /> },
        ...
        <span className={css.rowActions}>
          <Menu
            ...
            onSelect={(id) => {
              ...
              if (id === 'move') onMoveToProject(node.id)
