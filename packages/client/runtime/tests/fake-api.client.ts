...
export class FakeApiClient implements IApiClient {
  ...
  onSuggestTitles: (payload: unknown) => Promise<RpcResponse<{ titles: string[] }>> = () => Promise.resolve(ok({ titles: [] }))
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    suggestTitles: (payload: unknown) => this.record('session.suggestTitles', payload, this.onSuggestTitles(payload)),
