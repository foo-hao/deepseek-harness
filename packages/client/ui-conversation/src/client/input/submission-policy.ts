...
import { BUSY_ENTER_FIELD, DEFAULT_BUSY_ENTER_BEHAVIOR, DEFAULT_ENTER_MODE, ENTER_MODE_FIELD } from '../../submission-settings.ts'
...
export class ComposerSubmissionPolicy {
  ...
  /** Live idle-state Enter preference shared by the settings row and composer. */
