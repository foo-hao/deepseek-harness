...
export const zh = {
  ...
  'placeholder.newlineMode': '{prompt} · Enter 换行，Cmd/Ctrl+Enter 发送',
  ...
  'settings.enterMode.title': '空闲时 Enter 键行为',
  'settings.enterMode.description': '仅在智能体空闲时生效；繁忙时由上方选项控制',
  'settings.enterMode.send': '发送',
  'settings.enterMode.newline': '换行',
...
export const en = {
  ...
  'placeholder.newlineMode': '{prompt} · Enter for newline, Cmd/Ctrl+Enter to send',
  ...
  'settings.enterMode.title': 'Enter behavior while idle',
  'settings.enterMode.description': 'Idle only; busy Enter follows the option above',
  'settings.enterMode.send': 'Send',
  'settings.enterMode.newline': 'Newline',
